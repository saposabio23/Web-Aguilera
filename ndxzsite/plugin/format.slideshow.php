...
class Exhibit
{
	...
	public function __construct()
	{
		...
		$this->nav_type = (isset($OBJ->abstracts->abstract['nav-type'])) ?
			$OBJ->abstracts->abstract['nav-type'] : 1;
	...
	public function createExhibit()
	{
		...
		$content = "<div id='textspace' class='$text_css'>\n<div class='titulo-proyecto'><last:ndxz_title /></div>" . $OBJ->vars->exhibit['content'] . "</div>\n";
		...
		$s .= "<a href='{{baseurl}}/projects/' class='back'>Back</a>";
		$s .= '<img src="{{baseurl}}/ndxzsite/img/rotate.png" class="rotation" style="width:23px"></img>';
		$s .= $layout;
		$s .= "</div>\n";
